...
<head>
    ...
    <script type="text/javascript" src="${symbol_dollar}{pageContext.request.contextPath}/jquery/jquery-1.3.2.js"></script>
    <script type="text/javascript" src="${symbol_dollar}{pageContext.request.contextPath}/jquery/jquery.json-1.3.js"></script>

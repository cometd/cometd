...
public class CometDMixinTest extends AbstractCometDTest {
    ...
    @Test
    public void testShallowMixin() {
        evaluateScript("""
                const obj1 = {foo: {}};
                const obj2 = cometd._mixin(false, {}, obj1);
    ...
    @Test
    public void testDeepMixin() {
        evaluateScript("""
                const obj1 = {foo: {}};
                const obj2 = cometd._mixin(true, {}, obj1);
    ...
    @Test
    public void testTargetParameterIsModified() {
        evaluateScript("""
                const obj1 = {foo: true};
                const obj2 = {bar: true};
                const obj3 = cometd._mixin(true, obj1, obj2);
    ...
    @Test
    public void testDeepMixinOfArrays1() {
        evaluateScript("""
                const obj1 = {foo: [{bar:true}]};
                const obj2 = {foo: [{baz:true}]};
                const obj3 = cometd._mixin(true, {}, obj1, obj2);
    ...
    @Test
    public void testDeepMixinOfArrays2() {
        evaluateScript("""
                const obj1 = {foo: [{bar:true}]};
                const obj2 = {foo: [undefined, {baz:true}]};
                const obj3 = cometd._mixin(true, {}, obj1, obj2);
    ...
    @Test
    public void testShallowMixinOverwritesNestedObjects() {
        evaluateScript("""
                const obj1 = {ext: {foo: true}};
                const obj2 = {ext: {bar: true}};
                const obj3 = cometd._mixin(false, {}, obj1, obj2);
    ...
    @Test
    public void testDeepMixinMergesNestedObjects() {
        evaluateScript("""
                const obj1 = {ext: {foo: true}};
                const obj2 = {ext: {bar: true}};
                const obj3 = cometd._mixin(true, {}, obj1, obj2);

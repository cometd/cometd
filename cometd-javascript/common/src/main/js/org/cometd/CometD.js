...
;(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        // AMD Definition
        define(['./Utils', './TransportRegistry'], factory);
    } else if (typeof require === 'function' && typeof exports === 'object') {
        // CommonJS
        module.exports = factory(require('./Utils'), require('./TransportRegistry'));
    } else {
        // Global Definition
        ...
        namespace.CometD = factory(namespace.Utils, namespace.TransportRegistry);
    }
}(this, function (Utils, TransportRegistry) {
    'use strict';

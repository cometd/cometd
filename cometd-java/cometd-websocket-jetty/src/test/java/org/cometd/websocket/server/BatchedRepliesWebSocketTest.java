...
public class BatchedRepliesWebSocketTest extends ClientServerWebSocketTest
{
    ...
    public void testBatchedReplies() throws Exception
    {
        ...
        final AtomicReference<List<Message.Mutable>> batch = new AtomicReference<List<Message.Mutable>>();
        final CountDownLatch repliesLatch = new CountDownLatch(1);
        ClientTransport transport = new org.cometd.websocket.client.WebSocketTransport(null, wsFactory, null)
        {
            @Override

...
public interface ServerSession extends Session {
     ...
     * <p>Listener objects that implement this interface will be notified of session addition.</p>
     *
     * @deprecated use {@link AddedListener} instead
     */
    @Deprecated
    public interface AddListener extends AddedListener {
        @Override
        public default void added(ServerSession session, ServerMessage message) {
            added(session);
        }
     ...
     * <p>Listeners objects that implement this interface will be notified of session removal.</p>
     *
     * @deprecated use {@link RemovedListener} instead
     */
    @Deprecated
    public interface RemoveListener extends RemovedListener {
        @Override
        public default void removed(ServerSession session, ServerMessage message, boolean timeout) {
    ...
    /**
     * @deprecated use {@link QueueMaxedListener} instead
     */
    @Deprecated
    public interface MaxQueueListener extends QueueMaxedListener {
        @Override
        public default boolean queueMaxed(ServerSession session, Queue<ServerMessage> queue, ServerSession sender, ServerMessage message) {
            return queueMaxed(session, queue, sender, (Message)message);
        }

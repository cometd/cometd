...
public class OortObserveCometTest extends OortTest {
    ...
    public void testMessagesDroppedOnlyInOneDirection() throws Exception {
        ...
        final Oort oortA = new Oort(bayeuxServerA, urlA) {
            @Override
        ...
        oortA.start();
        oorts.add(oortA);
        bayeuxServerA.addExtension(new BayeuxServer.Extension.Adapter() {
            @Override
            ...
            private boolean rcv(ServerMessage.Mutable message) {
                if (halfNetworkDown.get()) {

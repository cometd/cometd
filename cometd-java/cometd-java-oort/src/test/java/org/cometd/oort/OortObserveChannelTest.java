...
public class OortObserveChannelTest extends OortTest
{
    ...
    public void testObserveChannel() throws Exception
    {
        ...
        Assert.assertTrue(subscribeLatch3.await(1, TimeUnit.SECONDS));
        ...
        Assert.assertTrue(messageLatch1.await(1, TimeUnit.SECONDS));
        ...
        Assert.assertTrue(messageLatch1.await(1, TimeUnit.SECONDS));
        Assert.assertTrue(messageLatch3.await(1, TimeUnit.SECONDS));
    }

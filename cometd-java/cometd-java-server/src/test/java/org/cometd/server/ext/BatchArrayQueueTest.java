...
public class BatchArrayQueueTest
{
    ...
    {
        BatchArrayQueue<String> queue = new BatchArrayQueue<String>(16, this);
        ...
        Queue<String> target = new ArrayQueue<String>();
    ...
    {
        BatchArrayQueue<String> queue = new BatchArrayQueue<String>(2, this);

...
public class WebAppTest {
    ...
    private void start(Path webXML) throws Exception {
        ...
        copyWebAppDependency(org.cometd.websocket.server.common.AbstractWebSocketTransport.class, webINF);
        copyWebAppDependency(org.cometd.websocket.server.WebSocketTransport.class, webINF);
        copyWebAppDependency(org.cometd.websocket.server.JettyWebSocketTransport.class, webINF);
        copyWebAppDependency(org.cometd.websocket.client.common.AbstractWebSocketTransport.class, webINF);
        copyWebAppDependency(org.cometd.websocket.client.WebSocketTransport.class, webINF);
        copyWebAppDependency(org.cometd.websocket.client.JettyWebSocketTransport.class, webINF);
    ...
    public void testWebAppWithService() throws Exception {
        ...
        BayeuxClient client = new BayeuxClient(uri, new LongPollingTransport(null, httpClient));
        client.handshake();

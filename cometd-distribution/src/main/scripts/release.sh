...
cp -v ${COMETD_JS_SOURCE}/org/cometd.js ${COMETD_JS_DIR}
cp -v ${COMETD_JS_SOURCE}/org/cometd/AckExtension.js ${COMETD_JS_DIR}
cp -v ${COMETD_JS_SOURCE}/org/cometd/ReloadExtension.js ${COMETD_JS_DIR}
cp -v ${COMETD_JS_SOURCE}/org/cometd/TimeStampExtension.js ${COMETD_JS_DIR}
cp -v ${COMETD_JS_SOURCE}/org/cometd/TimeSyncExtension.js ${COMETD_JS_DIR}
...
cp -r -v ${COMETD_DOJO_SOURCE}/org/* ${COMETD_DOJO_DIR}/org
cp -v ${COMETD_DOJO_SOURCE}/dojox/cometd.js ${COMETD_DOJO_DIR}
cp -r -v ${COMETD_DOJO_SOURCE}/dojox/cometd/* ${COMETD_DOJO_DIR}/cometd

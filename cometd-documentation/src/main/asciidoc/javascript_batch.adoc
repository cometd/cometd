...
A burst of events on the client generates a burst of `publish()` to the server, but the automatic batch mechanism batches them automatically, making the communication more efficient.

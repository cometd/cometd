...
xref:_java_server_services_inherited[the inherited services section], and having
Spring's dependency injection (as well as other facilities) integrated greatly
simplifies development.

xref:_java_server_services_integration_spring_boot[Integration with Spring Boot] is
...
xref:_java_server_services_integration_spring_xml_based_spring_configuration[XML based configuration above],

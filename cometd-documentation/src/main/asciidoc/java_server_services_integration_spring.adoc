  ...
  <bean id="bayeux" class="org.cometd.server.BayeuxServerImpl" init-method="start" destroy-method="stop">
    <property name="transports">
      <list>
        ...
        <bean id="jsonTransport" class="org.cometd.server.http.jakarta.JakartaJSONTransport">
          <constructor-arg ref="bayeux" />
        </bean>
        <bean id="jsonpTransport" class="org.cometd.server.http.jakarta.JakartaJSONPTransport">
          <constructor-arg ref="bayeux" />
        </bean>
      </list>
    </property>

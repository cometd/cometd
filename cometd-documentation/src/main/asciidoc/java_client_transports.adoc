...
* `org.cometd.client.websocket.jakarta.WebSocketTransport`, based on the standard Jakarta WebSocket APIs.
Maven artifact coordinates: `org.cometd.java:cometd-java-client-websocket-jakarta`.

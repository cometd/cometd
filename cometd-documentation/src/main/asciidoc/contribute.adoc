...
In order to contribute code, you need to certify the
http://developercertificate.org/[Developer Certificate of Origin] and sign-off your
`git` commits using `git commit --signoff`.
...
The Developer Certificate of Origin (from http://developercertificate.org/):

====
[source,text]
----
include::http://developercertificate.org/[lines=14..49]
----
====
...
To contribute fixes or enhancements to the documentation or the tutorials, you can just issue

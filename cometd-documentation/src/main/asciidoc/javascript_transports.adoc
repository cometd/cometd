...
Recent browsers introduced the capability for `XMLHttpRequest` calls to be performed towards a different domain (see https://developer.mozilla.org/En/HTTP_access_control[HTTP Access Control]).

...
The CometD JavaScript library is a portable JavaScript implementation with a _vanilla_ implementation, entirely based on pure EcmaScript 6 and the standard objects available in the browser environment.
...
CometD also provides _bindings_ for JavaScript toolkits, currently https://jquery.com/[jQuery] and https://angularjs.org/[Angular 1].

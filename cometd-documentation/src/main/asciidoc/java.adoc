...
https://eclipse.org/jetty[Jetty Http Server and Servlet Container],
...
see also xref:_java_server_configuration_servlet_30[the Servlet 3.0 configuration section]
for further details.

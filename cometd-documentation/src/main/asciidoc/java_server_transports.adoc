...
xref:_bayeux[The Bayeux protocol] defines two mandatory transports based on HTTP:
...
in xref:_java_server_configuration_advanced[this section].
...
(see also xref:_java_server_configuration_advanced[this section]), you do not
...
xref:_java_client_transports[the Java client transports section].

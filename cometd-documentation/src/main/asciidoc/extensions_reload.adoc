...
xref:_extensions_acknowledge[the acknowledge extension section]). In this case,
...
under the name specified by the xref:_extensions_reload_configuration[configuration].

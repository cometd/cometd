...
xref:_extensions_acknowledge_ordering[the ordering section].
...
explained in xref:_java_server_configuration[the java server configuration section].
...
demos in xref:_installation_demos[the installation demos section].

...
There is an example of acknowledged messages in the ES6 chat demo that comes bundled with the CometD distribution, and instruction on how to run the CometD demos in xref:_installation_demos[the installation demos section].
...
$ mvn jetty:run
----
. Point your browser to `+http://localhost:8080/es6-examples/chat/+` and make

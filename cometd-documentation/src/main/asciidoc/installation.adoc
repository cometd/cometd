...
in production. See the xref:_installation_jetty[next section] for the suggested
...
You can follow xref:_primer[the Primer section] or the
...
Refer to xref:_java_server_configuration_servlet_30[this section] for further
...
Below you can find an example that shows how to setup Jetty embedded and
CometD with support for HTTP, HTTPS and WebSocket transports:

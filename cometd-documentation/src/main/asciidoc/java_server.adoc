...
the Bayeux protocol (see also xref:_java_server_configuration[the server configuration section]
...
one or more user-defined services, see also xref:_java_server_services[the services section],

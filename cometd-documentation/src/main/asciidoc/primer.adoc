...
----
$ cd /tmp
$ mvn archetype:generate -Dfilter=org.cometd.archetypes:jetty9
----
----
Choose archetype:
1: remote -> org.cometd.archetypes:cometd-archetype-dojo-jetty9 (-)
2: remote -> org.cometd.archetypes:cometd-archetype-jquery-jetty9 (-)
3: remote -> org.cometd.archetypes:cometd-archetype-spring-dojo-jetty9 (-)
4: remote -> org.cometd.archetypes:cometd-archetype-spring-jquery-jetty9 (-)
Choose a number:
----

As you can see, there are four archetypes available that build a skeleton application using the Dojo or jQuery JavaScript toolkits, both with the choice of using Jetty 9 and/or Spring.
Choose Dojo with Jetty 9, which is archetype number `1`.

Next, you have to choose the version of the archetype you want to use, typically the last version of the 5.0.x series:

----
Choose org.cometd.archetypes:cometd-archetype-dojo-jetty9 version:
...
52: 5.0.0
...
----
...
[INFO] Using property: cometdVersion = 5.0.0
[INFO] Using property: jettyVersion = 9.4.28.v20200408
[INFO] Using property: slf4jVersion = 1.7.30
...
----
include::../../../../cometd-archetypes/dojo-jetty9/src/main/resources/archetype-resources/src/main/webapp/application.js[]
----

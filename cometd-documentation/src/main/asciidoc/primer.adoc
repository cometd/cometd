...
----
Choose org.cometd.archetypes:cometd-archetype-vanilla-jetty12 version:
...
81: 8.0.0
...
----
...
Define value for property 'artifactId': : vanilla-jetty12-primer
...
artifactId: vanilla-jetty12-primer
...
Now point your browser at `+http://localhost:8080/vanilla-jetty12-primer+`, and you should see this message:

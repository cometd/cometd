...
3: remote -> org.cometd.archetypes:cometd-archetype-spring-es6-jetty12 (-)
4: remote -> org.cometd.archetypes:cometd-archetype-spring-jquery-jetty12 (-)
Choose a number:
----
...
Next, you have to choose the version of the archetype you want to use, typically the last version of the 9.0.x series:
...
[INFO] Using property: cometd-version = 9.0.0
[INFO] Using property: jetty-version = 12.1.0
...
...
cometd-version: 9.0.0
jetty-version: 12.1.0
...
Y: :
...
[INFO] BUILD SUCCESS
...
the application skeleton, since it can be easily changed afterward.
====
...
jetty-ee11-servlets-<version>.jar

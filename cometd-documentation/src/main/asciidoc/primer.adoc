...
As you can see, there are archetypes available that build a skeleton application using the Dojo or jQuery JavaScript toolkits, both with the choice of using Jetty and/or Spring.
Choose Dojo with Jetty, which is archetype number `1`.

Next, you have to choose the version of the archetype you want to use, typically the last version of the 8.0.x series:

----
Choose org.cometd.archetypes:cometd-archetype-dojo-jetty12 version:
...
81: 8.0.0
...
----

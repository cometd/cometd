...
----
Choose archetype:
1: remote -> org.cometd.archetypes:cometd-archetype-dojo-jetty12 (-)
...
Define value for property 'artifactId': : dojo-jetty12-primer
Define value for property 'version':  1.0-SNAPSHOT: :
Define value for property 'package':  org.cometd.primer: :
[INFO] Using property: cometdVersion = 8.0.0
[INFO] Using property: jettyVersion = 12.0.0
[INFO] Using property: slf4jVersion = 2.0.9
Confirm properties configuration:
groupId: org.cometd.primer
artifactId: dojo-jetty12-primer
...
Now point your browser at `+http://localhost:8080/dojo-jetty12-primer+`, and you should see this message:
...
----
include::../../../../cometd-archetypes/cometd-archetype-dojo-jetty12/src/main/resources/archetype-resources/src/main/webapp/application.js[]
----

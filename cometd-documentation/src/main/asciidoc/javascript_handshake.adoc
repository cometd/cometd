...
The server will be able to access the message from a `/meta/handshake` listener, for example using annotated services (see also xref:_java_server_services_annotated[the annotated services section]):
...
For more advanced processing of the handshake message, see xref:_java_server_authentication[the authentication section].

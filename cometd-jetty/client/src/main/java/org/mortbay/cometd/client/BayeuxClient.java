...
{
    private final static String __TIMER="org.mortbay.cometd.client.Timer";
    private final static String __JSON="org.mortbay.cometd.client.JSON";
    private final static String __MSGPOOL="org.mortbay.cometd.MessagePool";
